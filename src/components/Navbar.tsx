    ...
    >
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        <a href="/" className="flex items-baseline gap-1.5 group">
          ...
          <span className="font-cormorant font-semibold text-2xl text-sand-400 italic tracking-tight group-hover:text-sand-900 dark:group-hover:text-sand-50 transition-colors">
            stories
          </span>
        </a>
        ...
        <nav className="hidden md:flex items-center gap-8" aria-label="Primary navigation">
          ...
          >
            {isDark ? (
              <svg
                className="w-4 h-4 group-hover:text-sand-800 transition-colors"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}
              ...
              >
                <path
                  ...
                  d="M12 3v1m0 16v1m8.66-9H21M3 12H2m15.36-6.36l-.71.71M6.34 17.66l-.71.71M17.66 17.66l.71.71M6.34 6.34l.71.71M12 7a5 5 0 100 10A5 5 0 0012 7z"
                />
              </svg>
            ) : (
              <svg
                className="w-4 h-4 group-hover:text-sand-100 transition-colors"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}
      ...
      {mobileOpen && (
        <div className="md:hidden bg-sand-50/98 dark:bg-sand-950/98 backdrop-blur-md border-t border-sand-200 dark:border-sand-800">
          <nav className="flex flex-col px-6 py-4 gap-4" aria-label="Mobile navigation">
            ...
            <button
              onClick={toggleTheme}
              className="text-left text-sand-700 dark:text-sand-400 text-base"
            >
