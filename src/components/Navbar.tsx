      ...
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8" aria-label="Primary">
          ...
          <button
            ...
            className="w-8 h-8 flex items-center justify-center rounded-full text-sand-600 dark:text-sand-400 hover:text-sand-800 dark:hover:text-sand-100 hover:bg-sand-100 dark:hover:bg-sand-800 transition-colors"
          >
            {isDark ? (
